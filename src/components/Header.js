            ...
            <div className = "container">
                <header className="header" id="header">
                    ...
                    <div className="quick_link">
                        ...
                        <p>{info}</p>
                        <button onClick={() => this.increment()}><img src="https://cdn-icons-png.flaticon.com/512/5790/5790546.png" alt="increase elements"/></button>
                        <button onClick={() => this.decrement()}><img src="https://cdn-icons-png.flaticon.com/512/5790/5790239.png" alt="decrease elements"/></button>
                        <h1>{this.state.counter}</h1>
                        <a href = "URL"><i class="cart"><img src="https://cdn-icons-png.flaticon.com/512/2543/2543193.png" alt="din kundvagn"/></i></a>
                    </div>
                </header>
