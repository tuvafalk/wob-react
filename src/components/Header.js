        ...
        return(
            <div className = "container">
                <header className="header" id="header">
                    <div id="logo"><NavLink to={"/"}><img src="https://brave-pebble-0432f1103.2.azurestaticapps.net/src/WorldofBoardGames.com.png" /></NavLink></div>
                    <div id="quick_link">
                        <a target="_blank" href = "https://www.google.com/maps/place/Worldofboardgames.com/@63.8482097,20.3114261,15z/data=!4m2!3m1!1s0x0:0xc047bbd27173880b?sa=X&ved=2ahUKEwjF4LnVm6T9AhXL6CoKHWpSAYYQ_BJ6BAhxEAg"><i className="map"><img src="https://cdn-icons-png.flaticon.com/512/5767/5767387.png" alt="hitta till butiken" /></i></a>
